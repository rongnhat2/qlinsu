...
<html lang="en">
    ...
    <!-- Navbar-->
        <header class="app-header"><a class="app-header__logo" href="index.html">Lifetime</a>
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('images/giangtt.jpg')}}" alt="User Image">
                <div>
                  <p class="app-sidebar__user-name">Giang Trần</p>
                </div>
            </div>
            ...
            <ul class="app-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a class="treeview-item" href="bootstrap-components.html"> Nhân viên</a>
                        </li>

                        <li><a class="treeview-item" href="https://fontawesome.com/v4.7.0/icons/" target="_blank" rel="noopener">Thực tập sinh </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a class="treeview-item" href="form-components.html">Khen thưởng</a>
                        </li>
                        <li>
                            <a class="treeview-item" href="form-custom.html"> Kỷ luật</a>
                        </li>
                    </ul>
                </li>

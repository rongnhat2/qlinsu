                        ...
                        <form action="{{url('/department')}}" method="POST">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" name="dep_code" placeholder="" value="">
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" name="dep_name" placeholder="" value="">
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" name="dep_manager" placeholder="" value="">
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" name="dep_emp_total" placeholder="" value="">
